    ...
    return (
      <div className="flex h-screen items-center justify-center bg-slate-900">
        <div className="text-center">
          ...
          <p className="mt-4 text-sm font-medium text-slate-400">Đang kiểm tra quyền quản trị...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-md w-full text-center bg-white p-8 rounded-3xl border border-slate-100 shadow-xl space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-slate-500">
              Tài khoản của bạn không có quyền truy cập vào khu vực quản lý Admin. Vui lòng liên hệ quản trị viên hệ thống để biết thêm chi tiết.
            </p>
          </div>
          <div className="pt-2">
            <Link href="/">

  ...
  return (
    <div className="bg-rose-950/20 border border-rose-900/60 rounded-2xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 z-10 animate-pulse-slow">
      <div className="flex items-start gap-3">
        ...
        <div>
          <h4 className="text-slate-100 font-bold text-sm">Cảnh báo rủi ro học tập cao!</h4>
          <p className="text-slate-400 text-xs mt-0.5 leading-relaxed">
            Điểm nguy cơ rớt môn của bạn hiện tại đang ở mức báo động (<span className="text-rose-400 font-extrabold">{riskScore}%</span>). 
            Vui lòng củng cố các kỹ năng yếu hoặc chủ động thảo luận cùng Mentor.
          </p>
        </div>
      </div>

  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto font-sans select-none">
      ...
      {isLoading ? (
        ...
        <div className="py-12 text-center text-slate-500 text-sm font-semibold border-2 border-dashed border-slate-800 rounded-2xl">
        ...
        <>
          ...
          {myRank.rank > 0 && myRank.details && (
            <div className="bg-gradient-to-r from-blue-950/20 to-indigo-950/20 border border-blue-900/40 rounded-3xl p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
              <div className="flex items-center gap-4">

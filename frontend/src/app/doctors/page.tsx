...
const NearbyClinics = dynamic(() => import("@/components/ui/NearbyClinics"), {
  ssr: false,
  loading: () => (
    <div className="flex py-24 items-center justify-center">
      <LoadingSpinner className="h-8 w-8 text-teal-600 animate-spin" />
      <p className="ml-3 text-slate-500 text-sm font-medium">Đang tải bản đồ GPS...</p>
    </div>
  )
});
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex gap-6 border-b border-slate-100 pb-1">
        ...
        >
          📍 Tìm Phòng khám gần nhất (GPS Map)
        </button>
      </div>

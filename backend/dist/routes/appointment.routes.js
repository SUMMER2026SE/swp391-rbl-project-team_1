 ...
 */
router.post("/appointments", auth_middleware_1.verifyToken, (0, authorization_middleware_1.authorizeRoles)(client_1.Role.USER), doctor_middleware_1.validateDoctorAvailable, booking_middleware_1.validateBookingSlot, appointment_controller_1.createAppointmentHandler);
/**
 ...
 * Lấy trạng thái xếp hàng của cuộc hẹn
 */
router.get("/appointments/:id/queue-status", auth_middleware_1.verifyToken, appointment_controller_1.getAppointmentQueueStatusHandler);
